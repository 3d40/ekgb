# Generated by Django 3.1.7 on 2021-07-09 04:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jenis', models.CharField(choices=[('struktural', 'Struktural'), ('jfu', 'Fungsional Umum'), ('jft1', 'Ahli Pertma'), ('jft2', 'Ahli Muda'), ('jft3', 'Ahli Madya'), ('jft4', 'Ahli Utama'), ('jft5', 'Pelaksana Pemula'), ('jft6', 'Pelaksana'), ('jft7', 'Ahli Utama')], default='jfu', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tgllahir', models.DateField(blank=True, default='0000-00-00', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nomor_sk', models.CharField(blank=True, default='S-10225/BKD-2.2/', max_length=150, null=True, verbose_name='Nomor SK')),
                ('jenis', models.CharField(blank=True, max_length=50, null=True)),
                ('tanggal', models.DateField(blank=True, default=1998, null=True, verbose_name='Tanggal')),
                ('dokumen', models.FileField(blank=True, null=True, upload_to='upload/skpangkat/', verbose_name='Dokumen')),
                ('mk_tahun', models.IntegerField(default=0, null=True, verbose_name='Masa Kerja Tahun')),
                ('mk_bulan', models.IntegerField(default=0, null=True, verbose_name='Masa Kerja Bulan')),
                ('dasarnominatif', models.BooleanField(default=False, null=True)),
                ('tglpenetapan', models.DateField(blank=True, null=True, verbose_name='Tanggal Penetapan')),
                ('pejabat', models.CharField(blank=True, default='GUBERNUR JAMBI', max_length=50, null=True)),
                ('nama', models.ForeignKey(blank=True, default=24, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pegawai.golonganmodel', verbose_name='Nama Golongan')),
            ],
            options={
                'managed': (True,),
            },
